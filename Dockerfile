...
# ✅ CRITICAL: Create folders INSIDE public/storage
RUN mkdir -p /var/www/html/public/storage/projects/covers \
    && mkdir -p /var/www/html/public/storage/projects/gallery \
    && mkdir -p /var/www/html/public/storage/projects/pdfs \

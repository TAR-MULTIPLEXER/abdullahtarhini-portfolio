...
<style>
    /* ===== CSS VARIABLES ===== */
    :root {
    /* Change Primary to Darker Black/Slate */
    --primary: #0a0a0a; 
    
    /* Change Accent from Cyan to Gold */
...
<section id="home" class="hero">
    ...
    <div class="container hero-content">
        <span class="text-accent font-bold tracking-widest uppercase text-sm mb-4 block animate-pulse">
            Telecommunication Engineer & Developer
        </span>
        <h1 class="hero-title">
           key: Building Systems That <br>
            <span>Connect & Compute</span>
        </h1>
        <p class="hero-subtitle">
            LIU Graduate | Bridging telecom engineering with modern Laravel development 
            to create robust, connected solutions.
        </p>
        <div class="hero-cta">
        ...
        <div class="hero-stats">
            <div>
                <div class="hero-stat-value">{{$projectcount}}+</div>
    ...
    <!-- <div class="scroll-indicator">
       <a href="#projects" ><i class="fas fa-chevron-down text-2xl text-gray-400"></i></a>
    </div> -->
</section>
    ...
    <div class="container">
        <div class="about-grid">
            <div class="about-text">
                ...
                <p>
                    I'm a Telecommunication Engineering graduate from <strong>Lebanese International University (LIU)</strong> 
                    with a passion for full-stack web development. My unique background allows me to 
                    understand both hardware infrastructure and software applications.
                </p>
                <p>
                    I specialize in building POS systems, IoT solutions, and web applications using 
                    <strong>Laravel, PHP, and JavaScript</strong>. Whether it's designing network 
                    topologies or creating responsive web interfaces, I bring engineering precision 
                    to every project.
                </p>
                <div class="about-features">
                    <div class="about-feature">
                        <i class="fas fa-graduation-cap"></i>
                        <span class="text-gray-700">B.Sc. Telecom Engineering</span>
                    </div>
                    <div class="about-feature">
                    ...
                    <div class="about-feature">
                        ...
                        <span class="text-gray-700">Hardware Projects</span>
                    </div>
                    <div class="about-feature">
                        <i class="fas fa-network-wired"></i>
                        <span class="text-gray-700">Network Systems</span>
                    </div>
                </div>
            </div>
            <div class="about-image">
<img src="{{ asset('images/abd_logo.jpeg') }}" alt="Your Name">
</div>
    </div>
</section>
<section id="projects" class="projects">
    <div class="container">
        <div class="projects-header">
            ...
            <p class="text-gray-600">A collection of web applications, hardware projects, and telecom systems</p>
        </div>
        <div class="filter-buttons">
            <button class="filter-btn active" onclick="filterProjects('all', this)">All Projects</button>
            <button class="filter-btn" onclick="filterProjects('web', this)">Web Apps</button>
            <button class="filter-btn" onclick="filterProjects('desktop', this)">Desktop/POS</button>
            <button class="filter-btn" onclick="filterProjects('hardware', this)">Hardware</button>
            <button class="filter-btn" onclick="filterProjects('telecom', this)">Telecom</button>
        </div>
    ...
    <div class="container">
        ...
        <div class="skills-grid">
            ...
            <div class="skill-card">
                ...
                <h3 class="skill-title">Telecom & Hardware</h3>
                <div class="skill-tags">
...
function showProjectModal(project) {
    ...
    modal.querySelector('#modalImage').src = project.image || 'https://via.placeholder.com/800x400';
    modal.querySelector('#modalTitle').textContent = project.title;
    modal.querySelector('#modalCategory').textContent = project.category;
    modal.querySelector('#modalDescription').innerHTML = project.description;
    
    // Set badge color
    const badge = modal.querySelector('#modalType');
    const colors = { hardware: 'badge-orange', desktop: 'badge-purple', telecom: 'badge-blue', web: 'badge-cyan' };
    badge.className = 'badge ' + (colors[project.type] || 'badge-cyan');
    badge.textContent = project.type.charAt(0).toUpperCase() + project.type.slice(1);
